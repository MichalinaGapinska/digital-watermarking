...
{
    public partial class FFTColorForm : Form
    {
        public FFTColorForm()
        {
            InitializeComponent();
        ...
        private void file_chooser_click(object sender, EventArgs e)
        {
            ...
            var encoder = new FFTColorEncoder(originalImage, tb_message_original.Text);
