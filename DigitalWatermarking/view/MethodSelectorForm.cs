...
namespace DigitalWatermarking
{
    public partial class MethodSelectorForm : Form
    {
        ...
        private readonly object[] _encodingMethods = {MethodByteEncodingText, MethodByteEncodingImage,MethodByteWavelet, FFTEncodingImage, FFTColorEncodingImage, SinColorEncodingImage, CosColorEncodingImage, FFTMagnitude };
